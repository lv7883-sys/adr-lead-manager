...
async function captureOutbound(tenantId, msg, rawBody) {
  ...
  // resposta: o body ganha placeholder legível ('[áudio]'/'[imagem]'/…) e grava media_type.
  // media_url fica NULL de propósito (foto/vídeo/doc de saída não são baixados no recebimento):
  // a bolha oferece "Carregar mídia" e o endpoint /midia-baixar re-baixa sob demanda pelo raw.
