#!/usr/bin/env bash
# run-waedicao-itest.sh — paridade 6: ligacao e eventos de grupo viram aviso na conversa.
# PG DESCARTÁVEL. NUNCA toca produção.
set -euo pipefail
ROOT="$(cd "$(dirname "$0")/.." && pwd)"
PORT="${ITEST_PG_PORT:-55470}"
CTR="lm-waeventos-itest-pg"
...
node --test test/wa-eventos.itest.js
