#!/usr/bin/env bash
# run-aprendizado-privilegio-itest.sh — a consulta do aprendizado roda com o USUARIO DA APLICACAO.
# PG DESCARTÁVEL. NUNCA toca produção.
set -euo pipefail
ROOT="$(cd "$(dirname "$0")/.." && pwd)"
PORT="${ITEST_PG_PORT:-55474}"
CTR="lm-aprendizado-privilegio-itest-pg"
...
node --test test/aprendizado-privilegio.itest.js
