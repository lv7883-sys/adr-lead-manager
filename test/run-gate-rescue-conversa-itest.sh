#!/usr/bin/env bash
# run-gate-rescue-conversa-itest.sh — itest do Passo 1 (régua canônica de estágios src/stages.js).
# PG DESCARTÁVEL. NUNCA toca produção.
set -euo pipefail
ROOT="$(cd "$(dirname "$0")/.." && pwd)"
PORT="${ITEST_PG_PORT:-55451}"
CTR="lm-gate-rescue-itest-pg"
...
node --test test/gate-rescue-conversa.itest.js
