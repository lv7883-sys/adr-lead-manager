#!/usr/bin/env bash
# run-grade-polish-itest.sh — provisão da itest do POLISH da grade-recorrente: NOMES por vão +
# BURACOS classificados (sem_professor / sem_sala / sem_ambos) cobrindo 100% do expediente.
...
node --test test/grade-polish.itest.js
