#!/usr/bin/env bash
# run-saida-api-itest.sh — paridade 1: todo envio pela API aparece na hora, com conversa e tiques.
# PG DESCARTÁVEL. NUNCA toca produção.
set -euo pipefail
ROOT="$(cd "$(dirname "$0")/.." && pwd)"
PORT="${ITEST_PG_PORT:-55465}"
CTR="lm-saida-api-itest-pg"
...
node --test test/saida-api.itest.js
