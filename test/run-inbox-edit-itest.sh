#!/usr/bin/env bash
# run-inbox-edit-itest.sh — itest de editar/apagar do inbox (ADR-042 / E12-07). Evolution mockada.
# PG DESCARTÁVEL. NUNCA toca produção.
set -euo pipefail
ROOT="$(cd "$(dirname "$0")/.." && pwd)"
PORT="${ITEST_PG_PORT:-55455}"
CTR="lm-inbox-edit-itest-pg"
...
node --test test/inbox-edit.itest.js
