...
## 9. Coordenação
- **Migrations LM 127–139:** este ADR. **LM 120–125:** ADR-050 (boas-vindas, branch `feat/boas-vindas-e17-01`). **126** fica livre (buraco intencional; os grants de `app.*` do boas-vindas estão em `db/grants/boas_vindas_agenda_read.sql`).
